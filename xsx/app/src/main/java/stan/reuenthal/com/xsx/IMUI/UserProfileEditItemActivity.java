...
public class UserProfileEditItemActivity extends TActionBarActivity implements View.OnClickListener {
    ...
    private void findEditText() {
        ...
        editText.setDeleteImage(R.mipmap.nim_grey_delete_icon);
    }
    ...
    private void genderCheck(int selected) {
        otherCheck.setBackgroundResource(selected == GenderEnum.UNKNOWN.getValue() ? R.mipmap.xuanzhong : R.mipmap.weixuanzhong);
        maleCheck.setBackgroundResource(selected == GenderEnum.MALE.getValue() ? R.mipmap.xuanzhong : R.mipmap.weixuanzhong);
        femaleCheck.setBackgroundResource(selected == GenderEnum.FEMALE.getValue() ? R.mipmap.xuanzhong : R.mipmap.weixuanzhong);
    }
