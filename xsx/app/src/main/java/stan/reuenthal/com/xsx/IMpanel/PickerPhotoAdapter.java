...
public class PickerPhotoAdapter extends BaseAdapter {
    ...
    public void refreshView(int index) {
        ...
        if (list.get(index).isChoose()) {
            holder.select.setImageResource(R.mipmap.nim_picker_image_selected);
        } else {
            holder.select.setImageResource(R.mipmap.nim_picker_image_normal);
        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (list.get(position).isChoose()) {
            viewHolder.select.setImageResource(R.mipmap.xuanzhong);
        } else {
            viewHolder.select.setImageResource(R.mipmap.weixuanzhong);
        }
