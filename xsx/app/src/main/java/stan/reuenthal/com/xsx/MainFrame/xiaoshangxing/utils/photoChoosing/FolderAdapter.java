...
import stan.reuenthal.com.xsx.MainFrame.xiaoshangxing.setting.utils.photo_choosing.BitmapCache;
...
public class FolderAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return stan.reuenthal.com.xsx.MainFrame.xiaoshangxing.utils.photoChoosing.AlbumFragment.contentList.size();
    }
...
//			holder.imageView.setLayoutParams(lp);
        ...
        if (AlbumFragment.contentList.get(position).imageList != null) {
            ...
            holder.fileNum.setText("" + stan.reuenthal.com.xsx.MainFrame.xiaoshangxing.utils.photoChoosing.AlbumFragment.contentList.get(position).count);
...
//			holder.imageView.setImageBitmap( AlbumFragment.contentList.get(position).imageList.get(0).getBitmap());
            final ImageItem item = stan.reuenthal.com.xsx.MainFrame.xiaoshangxing.utils.photoChoosing.AlbumFragment.contentList.get(position).imageList.get(0);
    ...
    private class ImageViewClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ShowAllPhotoFragment.dataList = (ArrayList<ImageItem>) stan.reuenthal.com.xsx.MainFrame.xiaoshangxing.utils.photoChoosing.AlbumFragment.contentList.get(position).imageList;
            String folderName = stan.reuenthal.com.xsx.MainFrame.xiaoshangxing.utils.photoChoosing.AlbumFragment.contentList.get(position).bucketName;
