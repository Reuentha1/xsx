...
import stan.reuenthal.com.xsx.IMpanel.AttachmentStore;
import stan.reuenthal.com.xsx.IMpanel.BaseZoomableImageView;
import stan.reuenthal.com.xsx.IMpanel.BitmapDecoder;
import stan.reuenthal.com.xsx.IMpanel.Extras;
import stan.reuenthal.com.xsx.IMpanel.ImageUtil;
import stan.reuenthal.com.xsx.IMpanel.PickImageActivity;
...
public class PreviewImageFromLocalActivity extends TActionBarActivity {
    ...
    private void updateOriImageSizeTip(boolean isOrig){
        ...
        if(isOrig){
            ...
            originalImage.setImageResource(R.mipmap.nim_picker_orignal_checked);
        }else{
            originalImageSizeTip.setText(R.string.picker_image_preview_original);
            originalImage.setImageResource(R.mipmap.nim_picker_orignal_normal);
        }
    }
